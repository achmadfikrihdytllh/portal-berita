...
<div class="max-w-6xl mx-auto px-4 py-10">
    ...
    @if($latest)
        <div class="flex flex-col md:flex-row gap-8 mb-12 border-b border-slate-100 pb-10">
            <a href="{{ $latest->file_path_url }}" target="_blank" class="shrink-0 group">
            ...
            <div>
                ...
                <a href="{{ $latest->file_path_url }}" target="_blank"
    ...
    <div class="grid grid-cols-2 md:grid-cols-6 gap-4">
        @foreach($epapers as $epaper)
            <a href="{{ $epaper->file_path_url }}" target="_blank" class="group">
